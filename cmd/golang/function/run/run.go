...
var RunCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		subDir, err := cmd.Flags().GetString(common.FlagFunctionsSubDir)
		if err != nil {
		...
		absPath := function.FormAbsolutePathToFunctionsDir(projectRoot, srcDir, subDir)
		targetAbsPaths, err := function.FormAbsolutePathToFunctionTargetDirs(absPath, d.Targets)
		if err != nil {
